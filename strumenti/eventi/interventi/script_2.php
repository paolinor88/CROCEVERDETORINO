...
if (isset($_POST["cognome"])) {
    $inserisci = "INSERT INTO interventi_2 (COGNOME, NOME, NASCITA, INDIRIZZO, TELEFONO, SQUADRA, POSTAZIONE, ORAINIZIO, CODICEPATOLOGIA, CODICEGRAVITA, ESITO, STATO, NOTE, ORAFINE) VALUES (:cognome, :nome, :nascita, :indirizzo, :telefono, :squadra, :posizione, :inizio, :patologia, :gravita, :esito, :stato, :note, :fine)";
