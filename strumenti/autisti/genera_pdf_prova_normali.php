...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $datarientri = $_POST['datarientri'] ?? 'N/A';
    $tipoprova_label = $_POST['tipoprovalabel'] ?? 'N/A';
    $attenzione = $_POST['attenzione'] ?? 'N/A';
    $fluidita = $_POST['fluidita'] ?? 'N/A';
    $precisione = $_POST['precisione'] ?? 'N/A';
    ...
    <h2>VALUTAZIONE PROVA DI GUIDA NORMALI</h2>
    <table cellpadding='6' border='1' cellspacing='0'>
        ...
        <tr><td><strong>Data prova normali:</strong></td><td>{$data_prova}</td></tr>
    </table>
    <br>
    <h2>Punteggio</h2>
    <table cellpadding='6' border='1' cellspacing='0'>
        <tr><td><strong>Attenzione</strong></td><td>{$attenzione}</td></tr>
        <tr><td><strong>Fluidità</strong></td><td>{$fluidita}</td></tr>
        <tr><td><strong>Parcheggio</strong></td><td>{$precisione}</td></tr>
        <tr><td><strong>Toponomastica</strong></td><td>{$toponomastica}</td></tr>
        <tr><td><strong>Sicurezza</strong></td><td>{$sicurezza}</td></tr>
    </table>
        <h2>Commenti</h2>
    <table cellpadding='6' border='1' cellspacing='0'>
