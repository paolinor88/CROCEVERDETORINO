<nav class="navbar navbar-expand-lg navbar-cv shadow-sm mb-4">
    <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap">
        <div class="d-flex align-items-center flex-grow-1">
            ...
            <?php $page = basename($_SERVER['PHP_SELF']); if ($page === 'lezioni.php'): ?>
                <button class="menu-toggle-mobile d-sm-none me-2" onclick="toggleSidebar()" aria-label="Menu">
        ...
        <div class="d-flex align-items-center">
            <?php if (isset($_SESSION['nome'])): ?>
                <span class="navbar-text me-2 d-none d-sm-inline">
                    <i class="fas fa-user-circle me-1"></i> <?= $_SESSION['nome']; ?>
                </span>
