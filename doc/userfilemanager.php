...
$CONFIG = '{"lang":"it","error_reporting":false,"show_hidden":false,"hide_Cols":true,"calc_folder":false}';
...
//$auth_users = $db->query("SELECT ID, password FROM utenti")->fetch_array();
//echo $auth_users['ID'];
...
if ($_SESSION['livello']==2){
    $root_url = '/gestionale/doc/source/Normativa_e_Procedure';;
}elseif ($_SESSION['livello']==1){
    $root_url = '/gestionale/doc/source/dipendenti';
}elseif ($_SESSION['livello']>=4){
    $root_url = '/gestionale/doc/source';
}
...
$exclude_items = array('*.docx', '*.xls', '*.xlsx', 'Thumbs.db', '*.ppt', '*.pptx');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo "test"; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (FM_READONLY): ?>
                            <a title="<?php echo lng('Delete')?>" href="" onclick="return false;"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            <a title="<?php echo lng('Rename')?>" href="" onclick="return false;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <a title="<?php echo lng('CopyTo')?>..." href="" onclick="return false;"><i class="fa fa-files-o" aria-hidden="true"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php
