        ...
        $(function(){
            ...
            function renderBreadcrumbs(path) {
                var base = "",
                    ...
                    $html = $('<div/>').append( $('<a href="https://www.croceverde.org/elenco-dei-documenti-scaricabili/">croceverde.org</a></div>') );
...
<footer style="text-align: center">
    <div class="text-center">
        <font size="-4" style="color: lightgray; "><em>Powered for <a href="mailto:paolo.randone@croceverde.org">Croce Verde Torino</a><p>V 4.0</p></em></font>
    </div>
</footer>
