...
if(isset($_POST["invia"])){
   ...
   // $to= 'paolo.randone@croceverde.org';
    $subject="Richiesta cambio giorno".' '.$selectsett.'_'.$cognomerichiedente .'-'.$cognomeaccettante;
    ...
    $corpo = file_get_contents('../config/template/giorno.html');
...
<head>
    ...
    <title>Modulo cambio giornaliero</title>
...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cambio giorno</li>
        </ol>
    </nav>
</div>
<br>
...
<div class="container-fluid">
    <form action="cambiagiorno.php" method="post">
        <div class="jumbotron">
            <h3 style="text-align: center">RICHIESTA CAMBIO GIORNALIERO</h3>
            <br>
            <div class="col-md-12">
                <label for="selectsett">Il sottoscritto <?=$cognomenomerichiedente?> chiede di cambiare il turno del <b>giorno</b></label>
                <input type="date" class="form-control form-control-sm" id="selectsett" name="selectsett">
            </div>
            <br>
            <div class="col-md-12">
